        ...
        <form method="POST" action="{{ route('domains.update', $domain->id) }}">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="domain_name" name="domain_name"
                       value="{{ $domain->domain_name }}" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="ns1" name="ns1" value="{{ $domain->ns1 }}" required>
            </div>
            <div class="form-group">
                <label for="ns2">NS2</label>
                <input type="text" class="form-control" id="ns2" name="ns2" value="{{ $domain->ns2 }}" required>
            </div>
